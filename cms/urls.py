...
urlpatterns = oauth2_urlpatterns + [
    ...
    re_path(fr'^xblock/unit/container/{settings.USAGE_KEY_PATTERN}$', contentstore_views.xblock_unit_container_handler,
            name='xblock_unit_container_handler'),
    ...
    re_path(fr'^settings/score-board/{settings.COURSE_KEY_PATTERN}$',
            contentstore_views.score_board_handler, name='score_board_handler'),
    re_path(fr'^settings/student-overview/{settings.COURSE_KEY_PATTERN}$',
            contentstore_views.student_overview_handler, name='student_overview_handler'),
